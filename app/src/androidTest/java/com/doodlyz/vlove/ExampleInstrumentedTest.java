...
public class ExampleInstrumentedTest {
    ...
    public void mockFanship() {
        ...
        request = new VloveRequest.ApiRequest(url, future, future);
    ...
    public void test1() throws ExecutionException, InterruptedException {
        ...
        VloveRequest.with(context).setCookie("https://www.vlive.tv", cookie);
        ...
        VloveRequest.ApiRequest request = new VloveRequest.ApiRequest(api, future, future);
