...
public class Translator extends BaseDialog {
    ...
    public void translate(String urlOrContent) {
        mExtraPost = urlOrContent;
        show();
    }

    @Override
    public void show() {
        Intent intent = new Intent(getContext(), Translator.Dialog.class);
        intent.putExtra(Translator.Dialog.EXTRA_POST, mExtraPost);
    ...
    public static class Dialog extends Activity {
        ...
        private static final String EXTRA_POST = Dialog.class.getSimpleName() + ".POST:LString";
